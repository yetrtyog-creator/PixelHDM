...
def config_to_dict(config: "PixelHDMConfig") -> dict:
    ...
    return {
        ...
        "use_dynamic_timestep_shift": config.use_dynamic_timestep_shift,
        "timestep_shift_type": config.timestep_shift_type,
        "timestep_shift_fixed": config.timestep_shift_fixed,
        "timestep_shift_base_shift": config.timestep_shift_base_shift,
        "timestep_shift_max_shift": config.timestep_shift_max_shift,
        "timestep_shift_base_seq_len": config.timestep_shift_base_seq_len,
        "timestep_shift_max_seq_len": config.timestep_shift_max_seq_len,
        "timestep_shift_clamp_linear": config.timestep_shift_clamp_linear,
        ...
        "mrope_img_max_height": config.mrope_img_max_height,
        "mrope_img_max_width": config.mrope_img_max_width,
        "mrope_theta": config.mrope_theta,
        "pixel_rope_type": config.pixel_rope_type,
        "pixel_rope_max_size": config.pixel_rope_max_size,
        "time_embed_dim": config.time_embed_dim,
        "max_patches": config.max_patches,
        "token_compaction_expand_gain": config.token_compaction_expand_gain,
        "text_processor_layers": config.text_processor_layers,
        "text_processor_mlp_ratio": config.text_processor_mlp_ratio,
        "text_processor_use_qk_norm": config.text_processor_use_qk_norm,
        "image_processor_layers": config.image_processor_layers,
        "image_processor_mlp_ratio": config.image_processor_mlp_ratio,
        "image_processor_use_qk_norm": config.image_processor_use_qk_norm,
        "image_processor_use_timestep": config.image_processor_use_timestep,
